...
CardTen::CardTen(const CellPosition & pos) : Card(pos) // seting the cell position of the card
{
	cardNumber = 10; // seting the inherited cardNumber data member with the card number (1 here)
}
int CardTen:: fees=0;
int CardTen:: priceOfCard=0;
int CardTen:: avaliable=0;
...
bool CardTen::IsOverLapping(GameObject* pGO)
{
