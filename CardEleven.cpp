...
CardEleven::CardEleven(const CellPosition & pos) : Card(pos) // seting the cell position of the card
{
	cardNumber = 11; // seting the inherited cardNumber data member with the card number (1 here)
}
int CardEleven:: fees=0;
int CardEleven:: priceOfCard=0;
int CardEleven:: avaliable=0;
...
bool CardEleven::IsOverLapping(GameObject* pGO)
{
