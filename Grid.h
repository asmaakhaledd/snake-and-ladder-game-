...
public:
	...
	void SaveAll(ofstream& OutFile, GOT Type);
	...
	//void SaveAll(ofstream& saveFile, ObjectType Obj);
	...
	//void SaveAll(ofstream& OutFile, int Type,string fname);
	//void LoadAll(ifstream& InFile, int Type, string fname);

	void ClearGrid();	//Deleting All GameObjects From the Grid
	void SetCardOwners(Player*);
